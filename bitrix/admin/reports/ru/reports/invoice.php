...
<br>
Адрес доставки: <?=$arOrder["USER_DESCRIPTION"]?><br>
...
<br>
После того, как вы сообщили нам о товаре НЕНАДЛЕЖАЩЕГО качества, в течение дня к вам приедет наш курьер, заберет товар и вернет деньги или же обменяет его на другой товар, в зависимости от вашего выбора.
<br>
...
<tr>
<td width="20%">
<p class=MsoNormal>Отправитель:</p>
</td>
<td width="80%">
