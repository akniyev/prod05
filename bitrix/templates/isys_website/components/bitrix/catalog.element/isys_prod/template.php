...
<div class="col-md-9 col-lg-9 col-sm-12 col-xs-12 <? echo $templateData['TEMPLATE_CLASS']; ?>" id="<? echo $arItemIDs['ID']; ?>">



    <h2 class="text-left text-right margn-bot-20 darkgreentext">
    ...
    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 nopad-left">
        ...
        } elseif (isset($arResult["PREVIEW_PICTURE"]) && ($arResult["PREVIEW_PICTURE"]["SRC"] != "")) {
            $imgFile = $arResult["PREVIEW_PICTURE"]["SRC"];
        } else {
            $imgFile = $arResult["PREVIEW_PICTURE"]["SRC"];
        }
    ...
    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12 nopod-mdlg proddescription">
        <?if ('' != $arResult['DETAIL_TEXT']) {
            if ('html' == $arResult['DETAIL_TEXT_TYPE']) {
                echo $arResult['DETAIL_TEXT'];
            } else {?>
                <h4 class="text-left"><? echo $arResult['DETAIL_TEXT']; ?></h4><?
            }
        } else {?>
            <h4 class="text-left"><?=$arResult['PREVIEW_TEXT'];?></h4>
        <?}?><br>
    ...
    <h3 class="text-left margn-bot-20 darkbluetext">
...
?>
	<div class="bx_stick_disc right bottom" id="<? echo $arItemIDs['DISCOUNT_PICT_ID'] ?>">
        <? echo -$arResult['MIN_PRICE']['DISCOUNT_DIFF_PERCENT']; ?>%</div>
<?
		}
	}
	else
