...
// remove SECTION_CODE get param
$queryStr = $arResult['NavQueryString'];
if ($queryStr != null){
    $queryStr = str_replace('&amp;', '&', $queryStr);
    parse_str($queryStr, $chunks);
    unset($chunks['SECTION_CODE']);
    $queryStr = http_build_query($chunks, '', '&amp;');
    $arResult['NavQueryString'] = $queryStr;
}
//Trace($arResult);

// TODO: make clean urls
