...
<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
	...
	<p class="text-justify">
		Ваш заказ под номером <span class="darkbluetext">XXX</span> сформирован и передан на обработку. В ближайшее время мы свяжемся с Вами по телефону, который вы указали:
		<span class="darkbluetext"><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;+7 (988) 888-88-88</span>.
	</p>
	<p class="text-justify">
		Пожалуйста ожидайте.
